...
$(function () {
  ...
  var AppAjaxNavigation = {
    ...
    pageLoadedActions: function (scripts, css, components, features) {
      if ($.debug) {
        console.log("[pageLoadedActions] Init");
      }
      ...
      $LAB.setOptions({
        ...
        .wait(function () {
          ...
          if ($.debug) {
            console.log("[pageLoadedActions] Finished");
          }
        });
    },
    ...
    hideSplashScreen: function () {
      $("#splash-screen").fadeOut(800, function () {
        ...
        if ($.debug) {
          console.log("[App] System Fully Loaded");
        }
      });
    }
  };
  ...
  var AppSidebar = {
    ...
    submenu: function (event, element) {
      ...
      var updateSubmenuState = function (item, state) {
        var c = state;
        if (item.hasClass("lastChild")) {
          c += " lastChild";
        }
        if (item.hasClass("hasMenu")) {
          c += " hasMenu";
        }
  ...
  var AppComponents = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] Init");
      }
  ...
  var ComponentPanel = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Panel Init");
      }
  ...
  var ComponentCheckbox = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Checkbox Init");
      }
  ...
  var ComponentSelect = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Selectbox Init");
      }
  ...
  var ComponentDropdown = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Dropdown Init");
      }
  ...
  var ComponentTooltip = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Tooltip Init");
      }
  ...
  var ComponentModals = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Modals Init");
      }
      $(".modal").on({
  ...
  var ComponentFloatingLabels = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > FloatingLabels Init");
      }
  ...
  var ComponentScrollbar = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Scrollbar Init");
      }
  ...
  var ComponentMaterialRipple = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > MaterialRipple Init");
      }
  ...
  var ComponentSnackbar = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Snackbar Init");
      }
      $.snackbar();
    }
  };
  ...
  var ComponentToast = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Toast Init");
      }
      $.toasts({
        oneAtTime: false,
  ...
  var ComponentSubheader = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > Subheader Init");
      }
  ...
  var ComponentSimplePieCharts = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > SimplePieCharts Init");
      }
  ...
  var ComponentLinearProgress = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > LinearProgress Init");
      }
  ...
  var ComponentCircularProgress = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > CircularProgress Init");
      }
  ...
  var ComponentSpeedDial = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > SpeedDial Init");
      }
  ...
  var ComponentCKEditor = {
    init: function () {
      if ($.debug) {
        console.log("[AppComponents] > CKEditor Init");
      }
